		...
		<div class="row mt">
			<div class="col-lg-12">
				<div class="form-panel">
					<form role = "form" action="modifyPage" class="form-horizontal style-form" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="userId" class="form-control"
									value="${boardVO.userId}" disabled>
							</div>
						</div>
						<div class="form-group">
						
						<label class="col-sm-2 col-sm-2 control-label" for="boardImg">이미지</label>
							<div class="col-sm-10">
								<input type="file" id="boardImg" name="file" />
						 <div class="select_img">
						  <img src="${boardVO.boardImg}" />
						  <input type="hidden" name="boardImg" value="${boardVO.boardImg}" />
						  <input type="hidden" name="boardThumbImg" value="${boardVO.boardThumbImg}" /> 
							</div>
						</div>
			...
			<script>
				$(document).ready(function() {
					...
					$(".btn-warning").on("click", function(){
						...
						self.location="/bbs/pageList?page=${fCri.page}&numPerPage=${fCri.numPerPage}"
