				...
				<div class="form-panel">
					<form  role="form" class="form-horizontal style-form" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="csNo" value="${cvo.csNo}" readonly="readonly">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 col-sm-2 control-label">제목</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="csTitle" value="${cvo.csTitle}">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea class="form-control" name="csContent" rows="4">${cvo.csContent}</textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="userId" class="form-control" value="${cvo.userId}" disabled>
							</div>
						</div>
...
<script>
	...
	$(document).ready(function(){
		...
		$("#btn_cancel").on("click", function() {
			self.location="/cs/list";  // 취소하기 누르면 다시 리스트 페이지로 (http://localhost:8080/bbs/list)
		});
